...
const HostVehicleSchema = new Schema(
  {
    ...
    make: String,
    model: String,
    bodyType: { type: String, enum: ["Sedan", "SUV", "Truck", "Van", "EV", "Other"] },
    seats: Number,
    transmission: { type: String, enum: ["Auto", "Manual"] },
    mileageBand: { type: String, enum: ["<50k", "50–100k", "100–150k", "150k+"] },
    availability: { type: String, enum: ["Weekdays", "Weekends", "Both"] },
    readiness: { type: String, enum: ["Ready now", "In 1–3 mo", "Just exploring"] },
  },
  { _id: false }
);
...
const HostDetailsSchema = new Schema(
  {
    ...
    insuranceStatus: { type: String, enum: ["personal", "commercial", "unsure"], default: "unsure" },
    handoff: { type: String, enum: ["in_person", "lockbox", "both"], default: "both" },
    pricingExpectation: String,
    fleetSize: { type: String, enum: ["1", "2_3", "4_9", "10_plus"], default: "1" },
    notes: String,
  },
  { _id: false }
);
...
const RenterDetailsSchema = new Schema(
  {
    ...
    dates: {
      ...
      typicalDurationBand: { type: String, enum: ["1-3", "4-7", "8+"], default: "1-3" },
    },
    prefs: {
    ...
    budgetBand: { type: String, enum: ["<50", "50_80", "80_120", "120_plus"], default: "50_80" },
    ageBand: { type: String, enum: ["u21", "21_24", "25_plus"], default: "25_plus" },
    notes: String,
  },
  { _id: false }
);
...
const leadSchema = new Schema(
  {
    // Primary identity
    email: { type: String, required: true, maxlength: 120, index: true, lowercase: true },
    ...
    roles: { type: [String], enum: ["host", "renter"], default: ["renter"], index: true },
    ...
    // Stages & scores
    stageHost: { type: String, enum: ["quick", "enriched", "n/a"], default: "n/a" },
    stageRenter: { type: String, enum: ["quick", "enriched", "n/a"], default: "n/a" },
